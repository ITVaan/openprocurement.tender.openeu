...
class TenderThresholdEULotResourceTest(BaseTenderContentWebTest):
    initial_auth = ('Basic', ('broker', ''))
    ...
    def test_add_tender_lot(self):
        ...
        self.assertEqual(
            ...
            'Can\'t add lot in current (complete) tender status'
        )
        ...
        self.assertEqual(
            response.json['errors'][0]['description'],
            'Can\'t update lot in current (active.pre-qualification) tender status'
        )
        ...
        self.assertEqual(
            response.json['errors'][0]['description'],
            'Can\'t update lot in current (active.pre-qualification.stand-still) tender status'
        )
        ...
        self.assertEqual(
            response.json['errors'][0]['description'],
            'Can\'t update lot in current (active.qualification) tender status'
        )
        ...
        self.assertEqual(
            response.json['errors'][0]['description'],
            'Can\'t update lot in current (active.awarded) tender status'
        )
...
def suite():
    ...
    suite.addTest(unittest.makeSuite(TenderThresholdEULotResourceTest))
    return suite
